<?php
App::uses('ConferenceLocationsController', 'Controller');

/**
 * ConferenceLocationsController Test Case
 *
 */
class ConferenceLocationsControllerTest extends ControllerTestCase {
