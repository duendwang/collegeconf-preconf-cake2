<?php
App::uses('RegistrationTeamAssignmentsController', 'Controller');

/**
 * RegistrationTeamAssignmentsController Test Case
 *
 */
class RegistrationTeamAssignmentsControllerTest extends ControllerTestCase {
