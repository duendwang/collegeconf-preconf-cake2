...
<?php echo $this->Form->create('Lodging'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Lodging'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lodging.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lodging.id'))); ?></li>
