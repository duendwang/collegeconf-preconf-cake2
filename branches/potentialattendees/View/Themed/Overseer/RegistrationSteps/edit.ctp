...
<?php echo $this->Form->create('RegistrationStep'); ?>
	<fieldset>
		<legend><?php echo __('Edit Registration Step'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('conference_id');
		echo $this->Form->input('locality_id');
		echo $this->Form->input('user_id', array('empty' => true,'default' => null));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RegistrationStep.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RegistrationStep.id'))); ?></li>
