<div class="registrationTeamsLocalities form">
<?php echo $this->Form->create('RegistrationTeamsLocality'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Registration Teams Locality'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RegistrationTeamsLocality.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RegistrationTeamsLocality.id'))); ?></li>
