<div class="content">
	<?php //print_r($totals);?>
        ...
        <h4 style="text-size:125%;color: red">Warning: data may be inaccurate until an email is received from the registration team indicating that this information has been updated.</h4>
	<br><?php echo $this->Html->link('Registration Summary', array('controller' => 'attendees', 'action' => 'summary'));?><br><br>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($finance['Conference']['code'], array('controller' => 'conferences', 'action' => 'view', $finance['Conference']['id'])); ?>
		</td>
