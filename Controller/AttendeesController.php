 ...
 */
	function _requirementCheck($locality = null) {
		if (is_null($locality)) {
                ...
                $attendees = $this->Attendee->find('all',array('conditions' => array('Attendee.conference_id' => $this->Session->read('Conference.default'),'Attendee.locality_id' => $locality_ids),'recursive' => -1));
