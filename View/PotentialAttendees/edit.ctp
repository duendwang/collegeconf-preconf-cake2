<div class="potentialAttendees form">
<?php echo $this->Form->create('PotentialAttendee'); ?>
	<fieldset>
		<legend><?php echo __('Edit Potential Attendee'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PotentialAttendee.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PotentialAttendee.id'))); ?></li>
