<div class="registrationSteps index">
	...
	<tr>
		<td><?php echo $this->Html->link($registrationStep['RegistrationStep']['id'], array('action' => 'edit',$registrationStep['RegistrationStep']['id'])); ?>&nbsp;</td>
		<td>
		...
		<td>
			<?php echo $this->Html->link($registrationStep['User']['name'], array('controller' => 'users', 'action' => 'view', $registrationStep['User']['id'])); ?>
		</td>
