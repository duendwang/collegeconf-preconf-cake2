<?php
App::uses('ConferenceDeadlinesController', 'Controller');

/**
 * ConferenceDeadlinesController Test Case
 *
 */
class ConferenceDeadlinesControllerTest extends ControllerTestCase {
