<?php
App::uses('RegistrationTeamsLocalitiesController', 'Controller');

/**
 * RegistrationTeamsLocalitiesController Test Case
 *
 */
class RegistrationTeamsLocalitiesControllerTest extends ControllerTestCase {
