<?php
App::uses('PartTimeRegistrationsController', 'Controller');

/**
 * PartTimeRegistrationsController Test Case
 *
 */
class PartTimeRegistrationsControllerTest extends ControllerTestCase {
