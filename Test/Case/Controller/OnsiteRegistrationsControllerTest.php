<?php
App::uses('OnsiteRegistrationsController', 'Controller');

/**
 * OnsiteRegistrationsController Test Case
 *
 */
class OnsiteRegistrationsControllerTest extends ControllerTestCase {
