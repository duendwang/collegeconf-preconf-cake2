<?php
App::uses('ConferenceDeadlineExceptionsController', 'Controller');

/**
 * ConferenceDeadlineExceptionsController Test Case
 *
 */
class ConferenceDeadlineExceptionsControllerTest extends ControllerTestCase {
